ALTER TABLE anatomy CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE dataset CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE dataset_display CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE dataset_epiviz CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE dataset_link CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE dataset_preference CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE dataset_shares CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE dataset_tag CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE folder CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE folder_member CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE gene CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE gene_cart CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE gene_cart_group_membership CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE gene_cart_member CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE gene_dbxref CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE gene_go_link CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE gene_symbol CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE ggroup CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE go CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE guser CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE layout CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE layout_group_membership CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE layout_members CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE mirna_family CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE note CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE organism CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE supplemental_images CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE tag CONVERT TO CHARACTER SET utf8mb4;
ALTER TABLE user_group_membership CONVERT TO CHARACTER SET utf8mb4;
